<script lang="ts">
	...
	const paths: Record<Name, string> = {
		...
		// 上げる側と**上下だけが違う**形にする。並べたときに対と読めるように。
		download: 'M10 4.6v9.8M6.4 10.8l3.6 3.6 3.6-3.6M3.4 16.4h13.2',
		...
		'arrow-down': 'M10 4.4V16M5.4 11.4L10 16l4.6-4.6',
		// 端末（D29）。枠の中に山括弧と下線。**Tera Term の面だと分かる形。**
		terminal: 'M2.6 4.2h14.8v11.6H2.6zM5.6 8l2.2 2-2.2 2M10.4 12.4h4',
		// 握られている印。**南京錠。**
		lock: 'M5.4 8.8h9.2v7.4H5.4zM7.4 8.8V6.6a2.6 2.6 0 015.2 0v2.2',
		// 停止。**丸ではなく四角**（再生の対）。
		stop: 'M5.6 5.6h8.8v8.8H5.6z',

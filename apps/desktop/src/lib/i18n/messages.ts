...
const en = {
	...
	'conn.grip': 'Drag to reorder. When focused, ↑ and ↓ move it.',
	'conn.moved': 'Reordered.',
	'conn.id': 'Identifier',
	...
	'operation.request.secret': 'Password for sudo on this server',
	'operation.request.secret.note': 'Used for this one run, then dropped. It is never saved, never written to the log, and never shown on the screen.',
	...
	'win.restore': 'Restore',
	'win.close': 'Close',
	'files.passphrase.title': 'This key needs a passphrase',
	'files.passphrase.note': 'Asked every time you connect. sshboard never stores it.',
	'conn.auth': 'How to sign in',
	'conn.auth.agent': 'ssh-agent',
	'conn.auth.key': 'Key file',
	'conn.auth.password': 'Password',
	'conn.auth.agent.help': 'Uses a key already loaded in ssh-agent. On Windows the agent service ships disabled, so pick another way there.',
	'conn.auth.key.help': 'The passphrase, if the key has one, is asked when you connect. It is never saved.',
	...
	'update.uptodate': 'sshboard {version} is the latest version.',
	'update.skip': 'Skip this version',
	'update.fold': 'Hide',
	'update.retry': 'Try again',
	'update.notes.more': 'Read all ({count} more)',
	'update.notes.less': 'Show less',
	'update.cuts': 'Restarting ends {count} open connection(s).',
	'update.cuts.both': 'Restarting ends {count} open connection(s) and the terminal.',
	'update.cuts.terminal': 'Restarting ends the open terminal.',
	'update.failed.network': 'Could not reach the update server. Check your connection and try again.',
	'update.failed.signature': 'The update signature could not be verified, so nothing was installed. Check where the update came from.',
	'update.failed.unknown': 'The update could not be completed. Try again; if it keeps happening, please report it.',
	"mcp.copied": "Copied.",
...
const ja: Catalog = {
	...
	'conn.grip': 'つかんで並べ替えます。フォーカス中は ↑ ↓ でも動きます。',
	'conn.moved': '並べ替えました。',
	'conn.id': '識別子',
	...
	'operation.request.secret': 'このサーバーの sudo のパスワード',
	'operation.request.secret.note': 'この 1 回だけに使い、すぐ捨てます。保存も、記録への書き出しも、画面への表示もしません。',
	...
	'win.close': '閉じる',
	'files.passphrase.title': 'この鍵にはパスフレーズが要ります',
	'files.passphrase.note': '繋ぐたびに聞きます。sshboard は保存しません。',
	'conn.auth': '繋ぎ方',
	'conn.auth.agent': 'ssh-agent',
	'conn.auth.key': '鍵ファイル',
	'conn.auth.password': 'パスワード',
	'conn.auth.agent.help': 'ssh-agent に入っている鍵を使います。Windows は agent が既定で無効なので、そこでは別のやり方を選んでください。',
	'conn.auth.key.help': 'パスフレーズが要る鍵なら、繋ぐときに聞きます。保存はしません。',
	'conn.password': 'パスワード',
	...
	'update.restart': '再起動',
	'update.check': '更新を確認',
	'update.checking': '確かめています…',
	'update.uptodate': '最新です（{version}）。',
	'update.skip': 'この版は飛ばす',
	'update.fold': '畳む',
	'update.retry': 'もう一度',
	'update.notes.more': '全文（あと {count} 件）',
	'update.notes.less': '閉じる',
	'update.cuts': '再起動すると、繋がっている {count} 本が切れます。',
	'update.cuts.both': '再起動すると、繋がっている {count} 本と、開いている端末が切れます。',
	'update.cuts.terminal': '再起動すると、開いている端末が切れます。',
	'update.failed.network': '更新の配布元に繋がりませんでした。回線を確かめて、もう一度お試しください。',
	'update.failed.signature': '更新の署名を確かめられなかったので、何も入れていません。配布元をご確認ください。',
	'update.failed.unknown': '更新を終えられませんでした。もう一度お試しください。続くようなら報告してください。',
	"mcp.copied": "写しました。",

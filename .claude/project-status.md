...
**2026-09-02 現在、PRD の読み取りツールが全部 ✅ になりました**（MCP は **34 本**）。
...
| `crates/sshboard-mcp` | 同居 MCP・**合言葉必須**（D23）。**34 本**のツール（下記） |
...
cargo test --workspace                                 →  370 passed; 0 failed（2026-09-09・実機込み）
